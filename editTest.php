...
if(isset($_POST['add_question'])){
    ...
    $option_e = $_POST['option_e'];
		$answer = $_POST['answer'];
		$add_question = " INSERT INTO questions(test_id, question, image, option_a, option_b, option_c, option_d, option_e, answer) VALUES('$test_id' ,'$question','$target_file','$option_a','$option_b','$option_c','$option_d','$option_e','$answer') ";
...
if(isset($_POST['edit_question'])){
    ...
    $option_e = $_POST['option_e'];
		$answer = $_POST['answer'];
		$edit_question = "UPDATE questions SET question = '$question' ,image= '$target_file', option_a = '$option_a', option_b = '$option_b', option_c = '$option_c', option_d = '$option_d', option_e = '$option_e',answer = '$answer' WHERE question_id = '$question_id' ";
  ...
  <body>
    ...
    <br><br>
      <div style="color:#154360;">
        <h1>Perbaharui Soal</h1>
        <h3>Nama Soal: <?php echo $t_result['test_name'] ?> </h3>
        <h3>Jenis Soal: <?php echo $t_result['subject'] ?></h3>
      </div>
      <a href="adminHome.php" class="scroll" style="left:10px;top:10px;position:fixed;"><i class="fa fa-close fa-2x"></i></a>
      <h2 class="btn btn-info" data-toggle="collapse" data-target="#add" style="height: 40px; width:100%;">Tambah Soal Pilihan Ganda</h2><br><br>
      <div id="add" class="collapse">
        <form method="post" action="" enctype="multipart/form-data">
            <div class="form-group">
              ...
              <input class="form-control" type="file" name="image" style="width: 300px;"> Tambah Gambar
            </div>
            ...
            <div class="form-inline form-group">
              <input class="form-control" type="text" name="option_e" placeholder="Option E" style="width: 550px;">
            </div>
            <div class="form-group form-inline" >
              <!--<input class="form-control" type="text" name="answer" placeholder="Answer Option" style="width: 300px;">-->
							<select name="answer" class="form-control" placeholder="Pilihan Ganda" style="width: 300px;" required>
				     		<option>a</option>
				     		<option>b</option>
								<option>c</option>
				     		<option>d</option>
      ...
      <h2 class="btn btn-info" data-toggle="collapse" data-target="#update" style="height: 40px; width:100%;">Perbaharui Pengaturan Soal</h2><br><br>
      <div id="update" class="collapse">
        <form method="post" action="">
        <div class="form-inline form-group">
          <input class="form-control" type="text" name="test_name" value="<?php echo $t_result['test_name'] ?>" style="width: 300px;"> Nama Soal
        </div>
        <div class="form-inline form-group">
          ...
          Waktu Mulai [saat ini: <?php echo $t_result['sdatetime'] ?> ]
          "2017-06-01T08:30"
        </div>
        <div class="form-inline form-group">
          ...
          Waktu Selesai [saat ini: <?php echo $t_result['edatetime'] ?> ]
        </div>
        <div class="form-inline form-group">
          <input class="form-control" type="number" name="test_duration" value="<?php echo $t_result['test_duration'] ?>" style="width: 300px;"> Waktu Pengerjaan
        </div>
        <br>
        <input type="submit" name="update_test" value="Update Test" class="btn btn-danger" style="height: 40px; width:300px;">
        </form>
      </div>
      <h2 class="btn btn-primary" data-toggle="collapse" data-target="#edit" style="height: 40px; width:100%;">Perbaharui Soal</h2><br><br>
      <div id="edit" class="collapse">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="form-inline form-group">
              <input class="form-control" type="text" name="option_e" value="<?php echo $q_res['option_e'] ?>" style="width: 550px;">
            </div>
            <div class="form-group">
            ...
            <input type="number" name="question_id" hidden value="<?php echo $q_res['question_id'] ?>" >
                <br>
            <input type="submit" name="edit_question" value="Perbaharui Soal" class="btn btn-danger" style="height: 40px; width:300px;">
