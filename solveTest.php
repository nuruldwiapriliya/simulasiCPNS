  ...
  <body onLoad="timeout()">
    <div class="container">
    	...
    	<div class="row" style="border:1px solid black;">
    		...
    		<div class="col-lg-2"><h3>Menit Tersisa</h2></div>
    	</div>
          ...
          <div id="mcq" class="tab-pane in fade active">
          	...
          	<table class="table table-striped">
                  ...
                  <tr>
          	      ...
          	      <tr>
          	        <td><input type="radio" value="a" name="<?php echo $q_res['question_id'] ?>"> A. 
          	        <?php echo $q_res['option_a'] ?></td>
          	      </tr>
          	      <tr>
          	        <td><input type="radio" value="b" name="<?php echo $q_res['question_id'] ?>"> B. 
          	        <?php echo $q_res['option_b'] ?></td>
          	      </tr>
          	      <tr>
          	        <td><input type="radio" value="c" name="<?php echo $q_res['question_id'] ?>"> C. 
          	        <?php echo $q_res['option_c'] ?></td>
          	      </tr>
          	      <tr>
          	        <td><input type="radio" value="d" name="<?php echo $q_res['question_id'] ?>"> D. 
          	        <?php echo $q_res['option_d'] ?></td>
                  </tr>
                  <tr>
                    <td><input type="radio" value="e" name="<?php echo $q_res['question_id'] ?>"> E. 
                    <?php echo $q_res['option_e'] ?></td>
                  </tr>
                  <tr>
